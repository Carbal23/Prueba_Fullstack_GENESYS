...
const COLORS = ['primary', 'secondary', 'info', 'success', 'warning', 'error', 'bluefast'] as const;
    ...
    const defaultStyle = {
      ...(inheritColor && {
        ...
        ...(containedVariant && {
          ...
          backgroundColor: lightMode ? theme.palette.primary.dark : theme.palette.common.white,
          '&:hover': {
            backgroundColor: lightMode ? theme.palette.primary.main : theme.palette.grey[400],
          },
        }),
        // OUTLINED
        ...(outlinedVariant && {
